function list_filter = filter_file_thresh_distance(tbl_data, filter_data)
...
for i = 1:size(list_threshold_x, 1)
    ...
    filt_Distance = contains(tbl_data.Distance, filter_data.Distance);
    filt_Dress = contains(tbl_data.Dress_variation, filter_data.Dress_variation);
